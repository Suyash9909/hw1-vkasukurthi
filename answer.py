...
def strings():
    ...
    print(stevens, stevens_7, length, great, good)
...
def list_1D():
    ...
    hoboken = " hoboken,is,awesome,i,like,it ".strip()
    ...
    print(hoboken,hoboken_list, hoboken_first_item, l, new_l)
